...
namespace QLHomeStay_App
{
    public partial class frm_LoaiPhong : Form
    {
       DAL_LOAI loai = new DAL_LOAI();
        ...
        {
            InitializeComponent();
            dgv_loai.DataSource = loai.getAllLoaiPhong();
        ...
        private void btn_them_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (d == DialogResult.Yes)
                {
                    ...
                    if (loai.insertLoaiPhong(txt_maloai.Text,txt_tenloai.Text,float.Parse(txt_giaphong.Text)))
                    {
        ...
        private void btn_capnhat_Click(object sender, EventArgs e)
        {
            ...
            if (d == DialogResult.Yes)
            {
                ...
                if (loai.updateLoaiPhong(txt_maloai.Text, txt_tenloai.Text, float.Parse(txt_giaphong.Text)))
